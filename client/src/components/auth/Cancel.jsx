...
const Cancel = () => {
  return (
    ...
    <Link to="/courses" className="px-4 py-2 block w-full rounded-full border border-green-300 text-sm font-medium text-white hover:text-black hover:bg-green-300 focus:outline-none focus:ring sm:w-auto text-center">Buy A Course?</Link>
